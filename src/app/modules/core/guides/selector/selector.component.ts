...
import { CoreEnumService, ErrorExceptionResult, FilterDataModel, FilterModel, CoreGuideModel, CoreGuideService } from 'ntk-cms-api';
...
export class CoreGuideSelectorComponent implements OnInit {
  ...
  displayFn(SiteCategory?: CoreGuideModel): string | undefined {
