...
export class CoreSiteCategoryCmsModuleEditComponent implements OnInit {
  ...
  DataGetOneContent(): void {
    ...
    this.coreSiteCategoryCmsModuleService.ServiceGetOneById(this.requestId).subscribe(
      (next) => {
        this.dataModel = next.Item;
        if (next.IsSuccess) {
          this.formInfo.FormTitle = this.formInfo.FormTitle + ' ' + next.Item.LinkCmsModuleId;
