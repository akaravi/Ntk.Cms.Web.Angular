...
import { CoreEnumService, ErrorExceptionResult, FilterDataModel, FilterModel, BiographyContentModel, BiographyContentService } from 'ntk-cms-api';
...
export class BiographyContentSelectorComponent implements OnInit {
  ...
  displayFn(user?: BiographyContentModel): string | undefined {
