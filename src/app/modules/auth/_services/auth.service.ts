...
//   // public methods
//   login(email: string, password: string): Observable<TokenInfoModel> {
//     this.isLoadingSubject.next(true);
//     return this.authHttpService.login(email, password).pipe(
//       map((auth: TokenInfoModel) => {
...
//       map((user: TokenInfoModel) => {
//         if (user) {
//           this.currentUserSubject = new BehaviorSubject<TokenInfoModel>(user);
//         } else {
//           this.logout();
//         }
//         return user;
