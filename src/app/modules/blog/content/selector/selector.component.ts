...
import { CoreEnumService, ErrorExceptionResult, FilterDataModel, FilterModel, BlogContentModel, BlogContentService } from 'ntk-cms-api';
...
export class BlogContentSelectorComponent implements OnInit {
  ...
  displayFn(user?: BlogContentModel): string | undefined {
