...
import { CoreEnumService, ErrorExceptionResult, FilterDataModel, FilterModel, BlogCategoryModel, BlogCategoryService } from 'ntk-cms-api';
...
export class BlogCategorySelectorComponent implements OnInit {
  ...
  displayFn(user?: BlogCategoryModel): string | undefined {
